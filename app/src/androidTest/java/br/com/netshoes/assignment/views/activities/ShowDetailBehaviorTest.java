...
public class ShowDetailBehaviorTest {

    private static final String BASIC_SAMPLE_PACKAGE
            = "br.com.netshoes.assignment";
    ...
    @Test public void testChangeText_sameActivity() {
        ...
        mDevice.findObject(By.res(BASIC_SAMPLE_PACKAGE, "testText"))
        ...
        UiObject2 changedText = mDevice
                .wait(Until.findObject(By.res(BASIC_SAMPLE_PACKAGE, "testText")),
                        500 /* wait 500ms */);
